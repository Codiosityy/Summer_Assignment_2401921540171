...
| Section | Description |
|---------|-------------|
| [About](#about-this-repository) | What this repo covers |
| [Progress Dashboard](#progress-dashboard) | Current stats and progress |
| [4-Week Schedule](#4-week-schedule) | Full roadmap |
| [Repository Structure](#repository-structure) | Folder layout |
| [Solutions Index](#solutions-index) | All 60 DSA + 4 OOPS problems |
| [OOPS Section](#oops-section) | OOP concepts and briefs |
| [Coding Standards](#coding-standards) | Code quality guidelines |
| [How to Use](#how-to-use) | Clone, compile, run |

---

## About This Repository

Summer college assignment: **60 DSA problems + 4 OOPS problems** across 4 weeks.

| Domain | Coverage | Location | Count |
|--------|----------|----------|:-----:|
| DSA | LeetCode problems by topic | `Week_X/Day_Y/` | 60 |
| OOPS | Object-Oriented Programming | `Week_X/OOPS/` | 4 |
| | | **Total** | **64** |

**Structure**: 15 DSA problems + 1 OOPS topic per week. 3 problems per day, 5 days per week.
...
**Daily**: 3 DSA problems/day (approx. 45-60 min) + 1 OOPS topic/week (approx. 90 min)
...
│   │   ├── 1.cpp                   # Reverse Words in a String III
│   │   ├── 2.cpp                   # Decode String
...
|:-:|---------|:----------:|-------|:--------:|:--------:|
| **1** | [Two Sum](https://leetcode.com/problems/two-sum/description/) | Easy | Hash Map | [C++](./Week_1/Day_1/1.cpp) | [Link](https://leetcode.com/problems/two-sum/) |
...
One OOPS topic per week, Java-based.
...
**Concepts**: Interface, Polymorphism, Encapsulation, Getters/Setters, Constructor injection, `@Override`, String comparison with `equalsIgnoreCase`, Future extensibility (new user roles = new class implementing the interface)
...
**File numbering**: Solutions are numbered sequentially within each `Day_Y/` folder (`1.cpp`, `2.cpp`, `3.cpp`). The LeetCode problem number is shown in the Solutions Index table, not the filename.

**Language choice**: DSA in C++ (LeetCode standard), OOPS in Java (assignment requirement).

### Adding a New Solution

1. **Folder** -- `Week_X/Day_Y/` for DSA, `Week_X/OOPS/` for OOPS
2. **File name** -- Next sequential number: `<n>.cpp` (or descriptive `.java`)
3. **Code format** -- Standard `Solution` class, approach comment, time/space complexity
4. **Update README** -- Mark row as done, link the file
5. **Commit** -- `Add <Problem Name> solution`

Reference: `Week_1/Day_1/` for formatting and structure.
...
1. Check [Progress Dashboard](#progress-dashboard) for current status
2. Review [4-Week Schedule](#4-week-schedule) for the full plan
3. Browse [Solutions Index](#solutions-index) -- only solved rows have links
4. Click solution links to view code on GitHub
5. Compare with original problems via LeetCode links
6. Check complexity in code comments
...
- Try to optimize or refactor any solution
...
- OOPS Language: Java
- Style: Clean, readable, commented
- Complexity: Time and space complexity analyzed
- Naming: Meaningful variable and function names
- Format: Standard LeetCode `Solution` class structure
